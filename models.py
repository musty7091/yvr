...
RATE  = Numeric(18, 6, asdecimal=True)   # Kur: 6 hane yeterli olur
...
def D(v, default="0"):
    ...
    # Decimal zaten geldiyse doğrudan al
    if isinstance(v, Decimal):
        return v

    # int/float geldiyse string üzerinden çevir (float'ta bilimsel gösterim olabilir)
